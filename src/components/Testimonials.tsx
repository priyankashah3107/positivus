...
const Testimonials = () => {
  return (
   ...
   <div className=' flex flex-col lg:flex-row items-center gap-6 lg:gap-10 mt-32 lg:mt-24 autoShow'>
      ...
      <div className="bg-[#191A23] w-[390px] md:w-full text-white rounded-bl-2xl rounded-br-2xl  h-24">
<div className='flex flex-row justify-center cursor-pointer items-center text-center gap-2 '>
