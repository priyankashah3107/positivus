...
const Services = () => {
  return (
    ...
    <div className="p-4 pl-6  lg:pl-20 lg:p-10 grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-2 mt-4 lg:gap-14">
     <Card title={"Search engine"} title2={"optimization"} img={"/services/s1.png"} btn={"/greenarr.svg"} para={"Learn More"} bgColor='#F3F3F3' 
     titleCol='#B9FF66' titleCol2='#B9FF66' />

     <Card title={"Pay-per-click"} title2={"advertising"} img={"/services/s2.png"} btn={"/greenarr.svg"} para={"Learn More"} bgColor="#B9FF66"
     titleCol='#ffffff' titleCol2='#ffffff' />

     <Card title={"Social Media"} title2={"Marketing"} img={"/services/s3.png"} btn={"/white.svg"} para={"Learn More"} bgColor="#191A23" titleCol='#ffffff' titleCol2='#ffffff' />
